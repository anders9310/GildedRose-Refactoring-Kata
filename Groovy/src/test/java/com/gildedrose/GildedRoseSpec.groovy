...
class GildedRoseSpec extends Specification {
    ...
    void "Aged brie is updated one time"() {
        given:
            Item agedBrie = ItemCreator.createAgedBrie(sellInBefore, qualityBefore)
    ...
    void "Legendary item is updated one time"() {
        given:
            Item legendaryItem = ItemCreator.createSulfuras(sellIn)
    ...
    void "Backstage pass is updated one time"() {
        given:
            Item backstagePass = ItemCreator.createBackstagePass(sellIn, qualityBefore)
